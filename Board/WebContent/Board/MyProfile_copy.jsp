...
<body>
	...
	<div id="Profile">
			<div style='text-align: center'>
				<!--  <img id="update_mypic_" src='/Board/img/pic_icon.png' />-->
				<iframe id="update_mypic_" src='/Board/Board/imgHandler.jsp#a' scrolling=no marginwidth=0 marginheight=0 frameborder=0>  </iframe>
			</div>
